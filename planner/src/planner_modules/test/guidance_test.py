...
from planner.src.planner_modules.src.constraints.guidance_constraints import GuidanceConstraints, GuidancePlanner
...
class TestSystemIntegration(unittest.TestCase):
	...
	def setUp(self):
		...
		with patch.object(BaseConstraint, 'get_config_value') as mock_get_config_value:
			...
			from planner.src.planner_modules.src.constraints.guidance_constraints import GuidanceConstraints
			self.guidance_constraints = GuidanceConstraints(self.solver)
