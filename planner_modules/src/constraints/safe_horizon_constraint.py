...
class SafeHorizonConstraint(BaseConstraint):
    ...
    def __init__(self, solver, settings=None):
        ...
        # Storage for constraint coefficients
    ...
    def set_parameters(self, parameter_manager, data, step):
        ...
        for disc_id in range(self.num_discs):
            for i in range(self.max_constraints_per_disc):
                ...
                a1_val = self._constraint_coefficients['a1'][disc_id][step - 1][i]
                a2_val = self._constraint_coefficients['a2'][disc_id][step - 1][i]
                b_val = self._constraint_coefficients['b'][disc_id][step - 1][i]
