...
class TestDecompConstraints(unittest.TestCase):
	...
	def test_initialization(self, mock_config):
		...
		# Check decomp utility initialization
		self.mock_decomp_util.set_local_bbox.assert_called_once_with(
			np.array([CONFIG_MOCK["decomp"]["range"], CONFIG_MOCK["decomp"]["max_constraints"]]))

	@patch('planner_modules.decomp_constraints.PROFILE_SCOPE')
	def test_update(self, mock_profile_scope, mock_config):
	...
	def test_get_occupied_grid_cells(self, mock_config):
	...
	@patch('planner_modules.decomp_constraints.set_solver_parameter')
	...
	def test_is_data_ready(self, mock_config):
		...
		self.assertEqual(missing_data, "Costmap ")
	...
	def test_visualize(self, mock_point_marker, mock_line, mock_config):
	...
	def test_project_to_safety(self, mock_config):
...
class TestSystemIntegration(unittest.TestCase):
	...
	def setUp(self):
		...
		self.planner._modules = [self.decomp_constraints]
