...
class GuidanceConstraints(BaseConstraint):
    ...
    def get_constraints(self, symbolic_state, params, stage_idx):
        ...
        vel_x = symbolic_state.get("vx") if "vx" in symbolic_state.vars else symbolic_state.get("v") * np.cos(symbolic_state.get("psi"))
        vel_y = symbolic_state.get("vy") if "vy" in symbolic_state.vars else symbolic_state.get("v") * np.sin(symbolic_state.get("psi"))
...
class GuidancePlanner:
    ...
    def set_reference_velocity(self, velocity):
        """Set the reference velocity for planner"""
    ...
    def load_obstacles(self, obstacles):
        """Load dynamic obstacles for planner"""
    ...
    def update(self):
        ...
        # Mark planner as successful if we have trajectories
    ...
    def succeeded(self):
        """Return whether the guidance planner succeeded"""
