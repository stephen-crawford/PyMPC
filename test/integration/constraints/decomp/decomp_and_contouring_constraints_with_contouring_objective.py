"""
Decomp And Contouring Constraints With Contouring Objective - Converted to Standardized Systems
...
class DecompAndContouringConstraintsWithContouringObjective(BaseMPCTest):
    """
    Decomp And Contouring Constraints With Contouring Objective using standardized systems.
...
if __name__ == "__main__":
    test = DecompAndContouringConstraintsWithContouringObjective()
