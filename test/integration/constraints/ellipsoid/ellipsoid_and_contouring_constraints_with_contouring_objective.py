"""
Ellipsoid And Contouring Constraints With Contouring Objective - Converted to Standardized Systems
...
class EllipsoidAndContouringConstraintsWithContouringObjective(BaseMPCTest):
    """
    Ellipsoid And Contouring Constraints With Contouring Objective using standardized systems.
...
if __name__ == "__main__":
    test = EllipsoidAndContouringConstraintsWithContouringObjective()
