"""
Ellipsoid and Contouring Constraints Test
...
def run(dt=0.1, horizon=15, start=(0.0, 0.0), goal=(20.0, 20.0), max_iterations=300):
    """Run Ellipsoid + Contouring constraints test using the framework."""
    ...
    config = TestConfig(
        ...
        num_obstacles=5,
        obstacle_dynamics=["gaussian"] * 5,  # Ellipsoid constraints work with Gaussian predictions
        test_name="Ellipsoid and Contouring Constraints Test",
