"""
Linear And Contouring Constraints Contouring Objective - Converted to Standardized Systems
...
class LinearAndContouringConstraintsContouringObjective(BaseMPCTest):
    """
    Linear And Contouring Constraints Contouring Objective using standardized systems.
...
if __name__ == "__main__":
    test = LinearAndContouringConstraintsContouringObjective()
