"""
Linear And Contouring Constraints With Contouring Objective - Converted to Standardized Systems
...
class LinearAndContouringConstraintsWithContouringObjective(BaseMPCTest):
    """
    Linear And Contouring Constraints With Contouring Objective using standardized systems.
...
if __name__ == "__main__":
    test = LinearAndContouringConstraintsWithContouringObjective()
