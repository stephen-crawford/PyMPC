"""
Linear Constraints Contouring Objective - Converted to Standardized Systems
...
class LinearConstraintsContouringObjective(BaseMPCTest):
    """
    Linear Constraints Contouring Objective using standardized systems.
...
if __name__ == "__main__":
    test = LinearConstraintsContouringObjective()
