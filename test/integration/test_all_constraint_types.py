"""
Test All Constraint Types - Converted to Standardized Systems
...
class TestAllConstraintTypes(BaseMPCTest):
    """
    Test All Constraint Types using standardized systems.
