"""
Working Road Following Test with Dynamic Obstacle

This test demonstrates a vehicle following a curved road while avoiding
a dynamic obstacle using the existing working framework.
"""
...
class TestRoadFollowingWorking(BaseMPCTest):
    """
    Working test for vehicle following a curved road while avoiding a dynamic obstacle.
    """
    
    def __init__(self):
        config = TestConfig(
            test_name="test_road_following_working",
