"""
Test Simple Goal Reaching - Converted to Standardized Systems
...
class TestSimpleGoalReaching(BaseMPCTest):
    """
    Test Simple Goal Reaching using standardized systems.
