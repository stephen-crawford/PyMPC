"""
Test Working Mpc Goal Reaching - Converted to Standardized Systems
...
class TestWorkingMpcGoalReaching(BaseMPCTest):
    """
    Test Working Mpc Goal Reaching using standardized systems.
...
if __name__ == "__main__":
    test = TestWorkingMpcGoalReaching()
