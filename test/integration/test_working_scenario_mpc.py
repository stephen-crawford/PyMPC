"""
Test Working Scenario Mpc - Converted to Standardized Systems
...
class TestWorkingScenarioMpc(BaseMPCTest):
    """
    Test Working Scenario Mpc using standardized systems.
