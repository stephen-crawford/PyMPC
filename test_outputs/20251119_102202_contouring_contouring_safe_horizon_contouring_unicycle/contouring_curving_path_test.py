...
- Safe Horizon constraints (for obstacle avoidance)
...
def run(dt=0.1, horizon=10, max_iterations=300, num_obstacles=3):
    ...
    # Contouring objective with contouring constraints (for road boundaries) and Safe Horizon constraints (for obstacle avoidance)
    ...
    config = TestConfig(
        ...
        constraint_modules=["contouring", "safe_horizon"],  # Contouring constraints for road boundaries + safe_horizon for obstacles
    ...
    print(f"Constraints: Contouring (for road boundaries) + Safe Horizon (for obstacle avoidance)")
