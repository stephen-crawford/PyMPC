...
class MPCCTestSuite:
    ...
    def _define_test_cases(self) -> List[TestCase]:
        ...
        cases.append(TestCase(
            ...
            tags=["linearized", "obstacle_avoidance"]
        ))
        ...
        cases.append(TestCase(
            ...
            duration=20.0,
            timeout=120.0,
            tags=["linearized", "multi_obstacle"]
        ))
        ...
        cases.append(TestCase(
            ...
            objective="contouring",
            constraints=["linearized", "contouring"],
            vehicle_model="contouring_unicycle",
            path_type="s_curve",
            path_length=20.0,
            num_obstacles=3,
...
def run_constraint_tests():
    ...
    suite = MPCCTestSuite()
    return suite.run_suite(tags=["safe_horizon", "gaussian", "linearized", "ellipsoid"])
